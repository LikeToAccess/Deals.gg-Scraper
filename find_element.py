...
class Find_Element:
	...
	def find_element(self, selector, sequence):
		try: return self.driver.find_element(selector, sequence)
		except NoSuchElementException: return None

	def find_elements(self, selector, sequence):
		try: return self.driver.find_elements(selector, sequence)
		except NoSuchElementException: return None

	def find_element_by_xpath(self, sequence):
		try: return self.find_element(By.XPATH, sequence)
		except NoSuchElementException: return None

	def find_elements_by_xpath(self, sequence):
		try: return self.find_elements(By.XPATH, sequence)
		except NoSuchElementException: return None
